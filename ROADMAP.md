...
*Updated 2026-05-01: Phase 2 active (M2.1 + M2.2 + M2.3 closed; M2.4 partial — DLX-only pipeline ships with 87% match on small subset, 3 documented gaps). Phase 1 closed; Phase 4 unblocked but not yet started.*
...
| 2 — Hybrid solver | L2 | 🟢 active (3/7 + M2.4 partial) | +16 weeks |
