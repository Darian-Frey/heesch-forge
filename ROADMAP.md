...
*Updated 2026-05-01: Phase 1 active (M1.1, M1.2a, M1.3, M1.4, M1.5 closed — M1.7 decision gate de facto triggered; M1.2b / M1.6 / formal M1.7 writeup outstanding).*

| Phase | Layers | Status | Target completion |
|-------|--------|--------|-------------------|
| 0 — Setup | — | ✅ done (6/6) | met |
| 1 — Engineering | L1 | 🟢 active (5/7; decision gate de facto triggered) | +8 weeks |
